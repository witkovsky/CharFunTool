function [fun,x,domain] = InterpChebPolyValues(values,x,domain)
% InterpChebPolyValues Evaluates the function fun by using Chebyshev
%   polynomial approximation specified by the function values evaluated at
%   Chebyshev points with specified domain.   
%
% SYNTAX:
%   [fun,x,domain] = InterpChebPolyValues(values,x,domain)
%
...
%   x      = linspace(-pi,pi)';
%   domain = [-pi,pi];
%   fun    = InterpChebPolyValues(values,x,domain)
