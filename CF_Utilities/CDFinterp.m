function cdf = CDFinterp(x,xGiven,cdfGiven)
%CDFinterp evaluates the interpolant for the CDF at specified values of x,
...
%
% SYNTAX:
%  cdf = CDFinterp(x,xGiven,cdfGiven)
%  cdf = CDFinterp(x,result)
%
% INPUT:
...
%  xGiven   = result.x;
%  cdfGiven = result.cdf;
%  cdf = @(x) CDFinterp(x,xGiven,cdfGiven);
