...
%cf2CDF  Evaluates the CDF from the characteristic function CF
...
% integrand function divided into sub-intervals (found by a fast
...
%  result   - structure with CDF  further details:
%
% EXAMPLE:
