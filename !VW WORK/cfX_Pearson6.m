function cf = cfX_Pearson6(t,alpha,beta)
%cfX_Pearson6(t,alpha,beta) Computes the characteristic function of the
% Pearson type VI distribution with parameters alpha > 0 (shape) and beta >
% 0 (scale), computed for real vector argument t, i.e. 
%   cf(t) = cfX_Pearson6(t,alpha,beta)
...
%  alpha = 3/2;
%  beta = 2/3;
%  cfX = @(t) cfX_Pearson6(t,alpha,beta);
