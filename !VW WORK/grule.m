...
%GRULE	[BP,WF]=GRULE(N) computes Gauss base points and weight factors 
%       for Gaussian quadrature  on interval [0 1]
% Reference
% Davis and Rabinowitz in 'Methods of Numerical Integration', page 365,
% Academic Press, 1975.
% Revised GKS 5 June 92
% (c) Gordon K Smyth, STATBOX 4.1
% Email: smyth @ wehi.edu.au
% STATBOX is a library of MATLAB statistical routines.
% The homepage of Statbox is at
% http://www.maths.uq.edu.au/~gks/matlab/statbox.html. 
%           
% Syntax: [bp,wf]=grule(n)
% (c) Viktor Witkovsky, VW 2004
