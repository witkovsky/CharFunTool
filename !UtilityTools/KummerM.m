function [h,l,alg]=KummerM(a,b,z,tol,maxj)
% KummerM Confluent hypergeometric function, 1F1 a.k.a Kummer's M
% function [h,l]=(a,b,z,tol,maxj) 
%
...
%
% This routine is functionally equivalent to the symbolic toolbox function
% hypergeom(a,b,z) but much faster. 
% The function calculated is the solution to z M'' + (b-z) M' - a M = 0
% where M' and M'' are 1st and 2nd derivatives of M with respect to z.
...
%     Mathematical Tables. Dover, New York, 9 edition, 1964. ISBN
%     0-486-61272-4. 
% [2] F. W. J. Olver, D. W. Lozier, R. F. Boisvert, and C. W. Clark,
%     editors. NIST Handbook of Mathematical Functions. CUP, 2010. ISBN
%     978-0-521-14063-8. 
% [3] J. Pearson. Computation of hypergeometric functions. Master’s thesis,
%     Oxford University, 2009. URL
%     http://¬people.maths.ox.ac.uk/¬porterm/¬research/-pearson_final.pdf. 
% [4] J. Pearson. Computation of hypergeometric functions. Matlab code,
%     Oxford University, 2009. URL
...
%   Adapted from hypergeom1f1.m ((C) Mike Brookes 2016) by 
%   Viktor Witkovsky (witkovsky@gmail.com)
%   Ver.: 20-Feb-2017 18:25:21
%
