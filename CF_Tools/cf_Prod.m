...
%% cf_Prod 
%  Characteristic function of product of two independent (continuous)
%  random variables, i.e. Y = X1 * X2. The distribution of teh first random
...
% cf = zeros(n,1);
% for i = 1:n
%     fun = @(x)  cfX1(x*t(i)) .* pdfX2(x);
%     cf(i) = integral(fun,a,b);
% end
