function cf = cf_GeneralizedLindlay(t,alpha,beta,gamma,coef,niid)
%% cf_GeneralizedLindlay 
%  Characteristic function of a linear combination (resp. convolution) of
%  independent GENERALIZED LINDLAY random variables (RVs) where X ~
...
%
%  That is, cf_GeneralizedLindlay evaluates the characteristic function
...
%
% SYNTAX
%  cf = cf_GeneralizedLindlay(t,alpha,beta,gamma,coef,niid)
%
% INPUTS:
...
%   cf     = cf_GeneralizedLindlay(t,alpha,beta,gamma);
...
%   beta   = [0.208, 2.852];
%   gamma  = [1.903, 0.552];
%   cf     = @(t) cf_GeneralizedLindlay(t,alpha,beta,gamma);
